insert into grampusFeedMaster values(default,'http://pipes.yahoo.com/pipes/pipe.run?_id=658cfaeb373eac290bdf40ca463f97ac&_render=rss','Grampus','',now());
insert into grampusFeedMaster values(default,'http://www.facebook.com/feeds/page.php?format=rss20&id=204986582962239','名古屋グランパス Facebook','名古屋グランパス Facebook',now());
insert into grampusFeedMaster values(default,'http://rssblog.ameba.jp/tamada-keiji/rss20.xml','玉田圭司オフィシャルブログ','玉田圭司オフィシャルブログ',now());
...
insert into grampusFeedMaster values(default,'http://kamisugi2.ocnsupport.jp/offworker/rss2.xml','名古屋グランパス不定点観測','名古屋グランパス不定点観測',now());
insert into grampusFeedMaster values(default,'http://football.way-nifty.com/junkissa/rss.xml','名古屋ローリングサンダー★★★','名古屋ローリングサンダー★★★',now());
insert into grampusFeedMaster values(default,'http://nagoya.cocolog-nifty.com/netesame/rss.xml','寝ても覚めてもグランパスＢＬＯＧ','寝ても覚めてもグランパスＢＬＯＧ',now());
insert into grampusFeedMaster values(default,'http://rssblog.ameba.jp/gamygamy/rss20.xml','しゃちちらし寿司','しゃちちらし寿司',now());
insert into grampusFeedMaster values(default,'http://lefthandermiwako.blog75.fc2.com/?xml&category=11','七転び八起き・・・　どうなるとっとこ一家？！','七転び八起き・・・　どうなるとっとこ一家？！',now());
insert into grampusFeedMaster values(default,'http://gra.boo-log.com/index.rdf','名古屋グランパス雑記','名古屋グランパス雑記',now());
