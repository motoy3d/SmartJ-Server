 ...
 * 検索結果ツイート
 */
create table sagamiharaSearchTweets(
 ...
 * 選手・関係者ツイート
 */
create table sagamiharaPlayerTweets(
	tweet_id long /*ツイートID*/
	,user_name varchar(256) /*ユーザ名*/
	,user_screen_name varchar(256) /* ユーザ表示名*/
	,user_profile_image_url text /* ユーザプロフィール画像URL*/
 ...
 * フィードマスター
 */
create table sagamiharaFeedMaster(
 ...
 */
create table sagamiharaAvoidFeed(
 ...
 * 日程・結果
 */
create table sagamiharaResults(
 season year
 ,compe varchar(40)
 ,game_date1 date
