...
//			List<Feed> entryList = collectFeedEntries();
...
//				FeedEntrySaver2 srv = new FeedEntrySaver2(teamId);
//				srv.saveEntries(targetFeed, entryList, qr);
//			}
//		} catch(Exception ex) {
//			ex.printStackTrace();
//		}
...
//	 * @param teamId
//	 */
//	public FeedEntrySaver2(String teamId) {
//		this.teamId = teamId;
//	}
//	
//	/**
//	 * feedMasterからフィードリストを取得して、
//	 * google feed apiを使用して各フィードのエントリリストを取得し、
...
//	 * @return
//	 */
//	public static List<Feed> collectFeedEntries() {
...
//				logger.info("★feed＝" + feedResult.getSiteName() + ".  " +  feedResult.getTitle() + ".  " + feedResult.getFeedUrl());
...
//	 * @throws SQLException
//	 */
//	private void saveEntry(/*Feed targetFeed,*/ List<Feed> feedResult, QueryRunner qr) throws SQLException {
